...
public class FileServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = -5226920499533214590L;
    ...
    public void init() throws ServletException {
        ...
        basePath =
                getServletContext().getRealPath(getInitParameter("basePath"));
    ...
    private void processRequest(
        ...
        File file =
                new File(basePath, URLDecoder.decode(requestedFile, "UTF-8"));
